...
/**
 * This class mimics some of abilities of the ImageView class,
 * and ads resizing, pinch-zooming and horizontal/vertical 
 * scrolling for images larger than the screen
 */
public class AdvancedImageView extends FrameLayout
{
